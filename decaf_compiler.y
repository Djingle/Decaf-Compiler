...
%token OBRACK CBRACK OPAR CPAR OSBRACK CSBRACK ARITHOP RELOP EQOP TYPE ASSIGNOP CONDOP ID CLASSPRO BOOL DEC HEX CHARLIT SEMICOL
...
t_fielDecl  : field_decl SEMICOL t_fielDecl								{printf("fin t_fielDecl\n");}
			| /*empty*/ 												{printf("t_fielDecl\n");}
			;

t_methoDecl : t_methoDecl method_decl									{printf("fin t_methoDecl\n");}
			| /*empty*/													{printf("t_methoDecl\n");}
			;
